...
function Filter() {
  ...
  useEffect(() => {
    ...
    if (!isPageReload) {
      ...
      // For example, restoring the cart from local storage
    ...
    // Clean up sessionStorage when the component unmounts
    return () => {
      sessionStorage.removeItem("isPageReload");
    };
  }, []); // Empty dependency array ensures this runs only on mount (page reload)
