                  ...
                  <a href="#" className="-m-2 flex items-center p-2">
                    ...
                    >
                      <div>
                        ...
                        {/* Example content to be translated */}
                        {/* <p data-translate>Hello, World!</p>
                        <p data-translate>This is an example paragraph.</p> */}
                      </div>
                    </span>
                  ...
                  <a href="#" className="flex items-center text-gray-700 ">
                    ...
                    >
                      {/* <select name="" id="lang">
                        ...
                        <option value="thai" id="th">Thai</option>
                        <option value="Chinese" id='chn'>Chinese</option>
                      </select> */}
